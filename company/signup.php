...
$sql = "INSERT INTO `client`(`email`,`password`, `name`, `fname`, `dob`, `gender`, `category`, `phone`, `languages`, `address`) VALUES ('$email','$pass','$name','$fname','$dob','$gender','$cat','$phone','$lang','$add');";
